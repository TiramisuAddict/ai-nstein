          ...
          <div class="content-wrapper">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              ...
              <div class="card">
                ...
                <div class="card-body">
                <a href="AfficherQuizs.php" class="btn btn-primary mb-3">Liste des Quiz </a>
                          ...
                          <tr>
                            ...
                            <td>
                              <form method="GET" action="AjouterReponse.php">
                                <input type="submit" class="btn btn-sm btn-outline-info" name="AjouterR" value="AjouterR">
                            ...
                            <td>
                            <a class="btn btn-sm btn-outline-secondary" href="SupprimerQuestion.php?idQuestion=<?php echo $question['idQuestion']; ?>&idQuiz=<?php echo $question['idQuiz']; ?>">Supprimer</a>
                            </td>
                          </tr>
                        </tbody>
                        <?php
