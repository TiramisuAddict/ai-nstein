                  ...
                  <div class="card-body">
                    ...
                    <form method="POST" class="forms-sample" name="form"  id="form" enctype="multipart/form-data" >
                      <div class="form-group">
                        ...
                        <input type="text" id="titre" name="titre" class="form-control mb-2" placeholder="Entrez Votre Titre" value="<?php echo $quiz['titre'];?>">
                        <div id="typeerror" class="error-message"></div>
                      </div>

                      <div class="form-group">
                        <label for="titre">Destination</label>
                        <textarea name="description" id="description" class="form-control mb-2" cols="30" rows="10" placeholder="Entrez le Description">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" id="difficulte" name="difficulte" class="form-control mb-3" value="<?php echo $quiz['difficulte'];?>">
                        <div id="typeerror" class="error-message"></div>
                      </div>

                      <button type="submit" class="btn btn-primary me-2 mb-2">Submit</button>
                      <a href="AfficherQuizs.php" class="btn btn-light mb-2">Cancel</a>
                    </form>
                  </div>
                </div>
