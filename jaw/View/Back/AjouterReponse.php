<?php
  ...
  if (isset($_GET["AjouterR"]) && isset($_GET["idQuestion"])) {
...
<div class="col-md-6 grid-margin stretch-card">
  <div class="card">
    <div class="card-body">
      <h4 class="card-title">Nouveau Reponse au question <?php echo $question['text']; ?></h4>

      <form method="POST" class="forms-sample" name="form"  id="form" enctype="multipart/form-data" onsubmit="return validateFormR();">

        <div class="form-group">
        <label for="titre">Text</label>
        <input type="text" id="textReponse" name="text" class="form-control mb-3" placeholder="Entrez Votre Text">
        <div id="textRerror" class="error-message"></div>
        </div>

        <div class="form-group">
        <label for="">Is Correct</label>
        <select class="form-select mb-3" name="isCorrect" id="isCorrect">
        ...
        <a href="AfficherReponses.php?idQuestion= <?php echo $idQuestion; ?>" class="btn btn-light">Cancel</a>
      </form>
    </div>
  </div>
</div>
