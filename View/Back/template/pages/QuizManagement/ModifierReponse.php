              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form method="POST" class="forms-sample" name="form"  id="form" enctype="multipart/form-data" >
                      ...
                      <input type="text" id="text" name="text" class="form-control" placeholder="Entrez Votre Text" value="<?php echo $Reponse['text'];?>">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-select" aria-label="Default select example" name="isCorrect">
