...
{
  $listTrajets = $TrajetC->Recherche($_GET['search']);
} elseif(isset($_GET['tr']))
{
  $listTrajets = $TrajetC->Tri($_GET['tr']);
}
else 
{
  $listTrajets = $TrajetC->AfficherTrajet();  
}*/
...
<body>
  <div class="container-scroller">
    ...
    <button type="submit" class="btn btn-primary">Search & Sort</button>
                ...
                <p>.</p>
                  <h4 class="card-title">Listes des Quiz</h4>
                          ...
                          <tr>
                            ...
                            <td>
                                            <form method="GET" action="AjouterQuestion.php">
                                                <input type="submit"  class="btn btn-info btn-sm" name="AjouterQ" value="AjouterQ">
                            ...
                            <td>
                              <a  class="btn btn-danger btn-sm"   href="SupprimerQuiz.php?idQuiz=<?php echo $quiz['idQuiz']; ?>">Supprimer</a>
                            </td>
                          </tr>
                        </tbody>
                        <?php
