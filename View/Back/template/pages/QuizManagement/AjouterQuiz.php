        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Nouveau Quiz</h4>
                  ...
                  <form method="POST" class="forms-sample" name="form"  id="form" enctype="multipart/form-data" onsubmit="return validateForm();">
                    ...
                    <textarea name="description" id="description" class="form-control" cols="30" rows="10" placeholder="Entrez le Description"></textarea>
                    <div id="descriptionerror" class="error-message"></div>
                    </div>

                    <div class="form-group">
                    <label for="titre">Difficulté :</label>
                    <input type="text" id="difficulte" name="difficulte" class="form-control" placeholder="Entrez le Difficulté">
