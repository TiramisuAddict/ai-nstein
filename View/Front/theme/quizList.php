  ...
  <div class="container">
    <div class="row">
      <div class="col-12 text-center">
        <h1 class="display-1 text-white font-weight-bold font-primary">Quiz List</h1>
      </div>
    </div>
  </div>
</section>
      ...
      <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
        <div class="card bottom-shape bg-secondary pt-4 pb-5">
          <div class="card-body text-center">
            <h4 class="text-white"><?php echo $quiz['titre']; ?></h4>
            <p class="text-light mb-4"><?php echo date_format($dateObject, 'l jS \of F Y A');?></p>
            <p class="text-white mb-4"><span class="display-3 font-weight-bold vertical-align-middle"><?php echo $quiz['difficulte']; ?></span></p>
            <ul class="list-unstyled mb-5">
              <li class="text-white mb-3"><?php echo $quiz['description']; ?></li>

            </ul>
            <a href="StartQuiz.php?idQuiz=<?php echo $quiz['idQuiz']; ?>" class="btn btn-outline-light">Start Quiz</a>
            </div>
        </div>
      </div>
